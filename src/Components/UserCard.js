...
const UserCard = ({user}) => {
  ...
  return (
    ...
    <div className='border-4 border-black rounded-lg w-fit mx-auto h-fit  top-20  bg-black'>
      ...
      <div className='flex gap-5 my-5 justify-center'>
        <button className='border border-black rounded-md bg-pink-400 p-2 w-24'onClick={()=>{handleSendRequest("interested",_id)}}>interested</button>
        <button  className='border border-black rounded-md bg-blue-400 w-24 p-2'onClick={()=>{handleSendRequest("ignored",_id)}}>ignore</button>
